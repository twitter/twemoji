...
```html
<script src="https://unpkg.com/twemoji@14.0.3/dist/twemoji.min.js" integrity="sha512-j3fVLgvTo527anyYyJOGTYJbG+vnnQYvE0m5mmkc1TK+nxAppkCLMIL0aZ4dblVCNoGShhm+kzE4ZUykBoMg4g==" crossorigin="anonymous"></script>
```
