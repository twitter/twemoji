...
* 🤡 [Twemoji Awesome](https://github.com/iamludal/twemoji-awesome) by [@iamludal](https://github.com/iamludal): Like [Font Awesome](http://fortawesome.github.io/Font-Awesome/), but for **Twemoji** (supports **v13.0** emojis, which means more than **3,300**).
* 💎 [Twemoji Ruby](https://github.com/jollygoodcode/twemoji) by [@JollyGoodCode](https://twitter.com/jollygoodcode): Use Twemoji in Ruby.
* ✏️ [Twemoji for Pencil](https://github.com/nathanielw/Twemoji-for-Pencil) by [@Nathanielnw](https://twitter.com/nathanielnw): Use Twemoji in Pencil.
